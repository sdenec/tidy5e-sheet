...
async function spellAttackMod(app, html, data) {
  ...
  html
    ...
    .attr("data-tooltip", `${spellAttackTextTooltip} [${spellAttackTextTooltipWithBonus}] `);
}
...
export function Tidy5eSheetInitialize() {
 ...
 */
export function Tidy5eSheetCreateActiveEffect(activeEffect, _config, options) {
 ...
 */
export function Tidy5eSheetUpdateActiveEffect(activeEffect, _config, options) {
  if (!(activeEffect?.parent instanceof Actor) || !_config.changes) {
    return;
  }
 ...
 */
export function Tidy5eSheetDeleteActiveEffect(activeEffect, _config, options) {
  if (!(activeEffect?.parent instanceof Actor) || !_config.changes) {
    return;
  }
