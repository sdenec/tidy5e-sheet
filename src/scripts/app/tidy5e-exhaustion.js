...
// Hooks Update Actor
// export function Tidy5eExhaustionUpdateActor(actorEntity, update, options, userId) {
...
export function Tidy5eExhaustionCreateActiveEffect(effect, data, id) {
  if (
...
export function Tidy5eExhaustionDeleteActiveEffect(effect, data, id) {
  if (
    game.settings.get(CONSTANTS.MODULE_ID, "exhaustionEffectsEnabled") == "dfredce" ||
    game.settings.get(CONSTANTS.MODULE_ID, "exhaustionEffectsEnabled") == "cub"
  ) {
